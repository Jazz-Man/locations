...
ClusterIcon.prototype.show = function () {
  if (this.div_) {
    ...
    e = "<img src='" + this.url_ + "' style='position: absolute; top: " + d + "px; left: " + b + "px; ";
    ...
    e += "'>";
    this.div_.innerHTML = e + "<div style='position: absolute;top: " + this.anchorText_[0] + "px;" + "left: " + this.anchorText_[1] + "px;" + "color: " + this.textColor_ + ";" + "font-size: " + this.textSize_ + "px;" + "font-family: " + this.fontFamily_ + ";" + "font-weight: " + this.fontWeight_ + ";" + "font-style: " + this.fontStyle_ + ";" + "text-decoration: " + this.textDecoration_ + ";" + "text-align: center;" + "width: " + this.width_ + "px;" + "line-height:" + this.height_ + "px;" + "'>" + this.sums_.text + "</div>";
...
Cluster.prototype.addMarker = function (e) {
  ...
  if (!this.center_) {
    ...
    if (this.averageCenter_) {
      ...
      var a = (
              this.center_.lat() * (
              l - 1) + e.getPosition().lat()) / l;
      var d = (
              this.center_.lng() * (
              l - 1) + e.getPosition().lng()) / l;
...
MarkerClusterer.prototype.onAdd = function () {
  ...
  this.listeners_ = [
    google.maps.event.addListener(this.getMap(), "zoom_changed", function () {
      ...
      if (this.getZoom() === (
        this.get("minZoom") || 0) || this.getZoom() === this.get("maxZoom")) {
...
MarkerClusterer.prototype.distanceBetweenPoints_ = function (b, e) {
  var R = 6371;
  var g = (
          e.lat() - b.lat()) * Math.PI / 180;
  var f = (
          e.lng() - b.lng()) * Math.PI / 180;
