$(document).ready(function($) {
  function changeCaptchaImage(reloadImage) {
    if (!wpdiscuzRecaptcha && (!isGoodbyeCaptchaActive && (isShowCaptchaForGuests || isShowCaptchaForMembers))) {
      ...
      if (isCaptchaInSession) {
        ...
        var src$$0 = captchaImg.attr("src");
        var fileUrl = src$$0.substring(0, src$$0.indexOf("=") + 1);
  ...
  wpdiscuzAjaxObj.setCommentMessage = function(field, messageKey, message, isFormError) {
    ...
    msgContainer.show().delay(4E3).fadeOut(1E3, function() {
      msgContainer.removeClass();
      msgContainer.addClass("wpdiscuz-comment-message");
      msgContainer.html("");
    });
  ...
  $(document).delegate(".wc_comm_submit, .wc_save_edited_comment", "click", function() {
    ...
    var errorMessages = $(".error-message", curentForm);
    var parent;
    var i = 0;
